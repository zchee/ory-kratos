...
replace github.com/ory/x => github.com/zchee/ory-x v0.0.0-20250616215630-74402d4fec8a // @spanner
...
require (
	...
	github.com/ory/herodot v0.10.4
...
require (
	...
	github.com/googleapis/go-sql-spanner v1.14.0 // indirect
